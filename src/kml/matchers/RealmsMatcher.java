...
public class RealmsMatcher implements URLMatcher{
    ...
    public boolean match(URL url){
        return url.toString().equalsIgnoreCase(realms_compatible) || url.toString().equalsIgnoreCase(realms_invites)
                || url.toString().equalsIgnoreCase(realms_trial) || url.toString().equalsIgnoreCase(realms_news)
                || url.toString().equalsIgnoreCase(realms_available) || url.toString().equalsIgnoreCase(realms_liveplayerlist)
                || url.toString().equalsIgnoreCase(realms_worlds) || realms_world_join.matcher(url.toString()).matches()
                || realms_uninvite.matcher(url.toString()).matches() || url.toString().equalsIgnoreCase(realms_pending)
                || realms_edit_join.matcher(url.toString()).matches() || url.toString().equalsIgnoreCase(realms_regions);
    }
    @Override
