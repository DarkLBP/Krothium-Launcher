...
function updateSkin(){
    if (document.getElementById("skinFile").files.length > 0){
        ...
        xhr.setRequestHeader("Content-Length", document.getElementById("skinFile").files.length);
...
function updateCape(){
    if (document.getElementById("capeFile").files.length > 0){
        ...
        xhr.setRequestHeader("Content-Length", document.getElementById("capeFile").files.length);
